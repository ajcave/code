...
hsymωt : ∀ {k} -> HSYM (App (SetU k)) (App ∘ ⟦_⟧tp') (App (SetU k)) (App ∘ ⟦_⟧tp')
hsymωt pA pA' (inj red1 red2 rel) = inj red2 red1 (hsym* pA pA' rel)

-- ⟦,⟧ctx-sym : ∀ {Γ : Ctx} {p : ⊨ Γ ctx} -> SYM ⟦ Γ , p ⟧ctx
-- ⟦,⟧ctx-sym {⊡} {tt} {⊡} {⊡} x = tt
-- ⟦,⟧ctx-sym {Γ , S} {vΓ , vT} {a , a₁} {b , a₂} (r1 , r2) = (⟦,⟧ctx-sym r1) , hsymωt (vT r1) (vT (⟦,⟧ctx-sym r1)) r2 
-- ⟦,⟧ctx-sym {⊡} {tt} {⊡} {b , a} ()
-- ⟦,⟧ctx-sym {⊡} {tt} {a , a₁} {⊡} ()
-- ⟦,⟧ctx-sym {⊡} {tt} {a , a₁} {b , a₂} ()
...
-- ⟦,⟧ctx-trans {⊡} {tt} {Syn.⊡} {Syn.⊡} {Syn.⊡} x1 x2 = tt
-- ⟦,⟧ctx-trans {⊡} {tt} {Syn.⊡} {Syn.⊡} {Syn._,_ ρ a} x1 ()
-- ⟦,⟧ctx-trans {⊡} {tt} {Syn.⊡} {Syn._,_ ρ a} () x2
-- ⟦,⟧ctx-trans {⊡} {tt} {Syn._,_ ρ a} {Syn.⊡} () x2
-- ⟦,⟧ctx-trans {⊡} {tt} {Syn._,_ ρ a} {Syn._,_ ρ' a'} () x2
...
-- ⟦,⟧ctx-irr {⊡} {tt} {tt} {Syn.⊡} {Syn.⊡} x = tt
-- ⟦,⟧ctx-irr {⊡} {tt} {tt} {Syn.⊡} {Syn._,_ ρ a} ()
-- ⟦,⟧ctx-irr {⊡} {tt} {tt} {Syn._,_ ρ a} ()
-- ⟦,⟧ctx-irr {Γ , S} {p , _} {q , _} {Syn.⊡} ()
-- ⟦,⟧ctx-irr {Γ , S} {p , _} {q , _} {Syn._,_ ρ a} {Syn.⊡} ()

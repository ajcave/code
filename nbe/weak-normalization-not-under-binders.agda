module weak-normalization-not-under-binders where
...
thm σ θ (ƛ M) = ([ σ ] (ƛ M) , (→*-refl , (ƛ ([ sub-ext σ ] M)))) , (λ N redN → reduce-closed (β _ _) (eq-ind (reduce ⊡ _) (lemma σ N M) (thm (σ ,, N) (reduce-ext θ redN) M)))

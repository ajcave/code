module contextual-substvars-spine-fancy where
open import Level
open import Unit
open import FinMap
...
mutual
 comb : ∀ {Ω} {Δ : mctx Ω} {Ψ₁} Ψ₂ {Φ} {A} -> tvar (Ψ₁ << Ψ₂) A -> spine Δ (Φ << Ψ₂) A i -> nsub Δ Φ Ψ₁
    -> ntm Δ (Φ << Ψ₂) i
 comb ⊡ top S (σ , N) = N ◇ S
 comb ⊡ (pop x) S' (σ , N) = comb ⊡ x S' σ
 comb (ψ , A) top S σ = ▹ top · S
 comb (ψ , T) (pop x) S σ = {!!}
 ...
 n-sub : ∀ {Ω} {Δ : mctx Ω} {Ψ₁} Ψ₂ {Φ} {A} -> ntm Δ (Ψ₁ << Ψ₂) A -> nsub Δ Φ Ψ₁ -> ntm Δ (Φ << Ψ₂) A
 n-sub Ψ (ƛ N) σ = ƛ (n-sub (Ψ , _) N σ)
 n-sub Ψ (▹ x · S) σ = comb Ψ x (sp-sub Ψ S σ) σ
 n-sub Ψ (u [ σ ] · S) σ' = (u [ ns-sub Ψ σ σ' ]) · sp-sub Ψ S σ'
 n-sub Ψ (p ♯[ σ ] · S) σ' = (p ♯[ ns-sub Ψ σ σ' ]) · sp-sub Ψ S σ'
 n-sub Ψ (π x ρ · S) σ = π x (rs-sub Ψ ρ σ) · sp-sub Ψ S σ

 sp-sub : ∀ {Ω} {Δ : mctx Ω} {Ψ₁} Ψ₂ {Φ} {A B} -> spine Δ (Ψ₁ << Ψ₂) A B -> nsub Δ Φ Ψ₁ -> spine Δ (Φ << Ψ₂) A B
 sp-sub Ψ ε σ = ε
 sp-sub Ψ (N , S) σ = (n-sub Ψ N σ) , (sp-sub Ψ S σ) 

 ns-sub : ∀ {Ω} {Δ : mctx Ω} {Ψ₁} Ψ₂ {Φ} {A} -> nsub Δ (Ψ₁ << Ψ₂) A -> nsub Δ Φ Ψ₁ -> nsub Δ (Φ << Ψ₂) A
 ns-sub Ψ ⊡ σ = ⊡
 ns-sub Ψ (σ , N) σ' = (ns-sub Ψ σ σ') , (n-sub Ψ N σ')
 ns-sub Ψ ([ xs ] ρ) σ = [ xs ] rs-sub Ψ ρ σ
 ns-sub Ψ (id xs) σ = {!!}

 rs-sub : ∀ {Ω} {Δ : mctx Ω} {Ψ₁} Ψ₂ {Φ} {A} -> rsub Δ (Ψ₁ << Ψ₂) A -> nsub Δ Φ Ψ₁ -> rsub Δ (Φ << Ψ₂) A

...
follows the handwritten proof directly, so we do not discuss it further.
...
Proofs in Beluga are written as recursive
functions, analyzing the construction of the underlying LF objects,
making recursive calls for appeals to the induction hypothesis. 

(Here, we proceed by
unboxing and pattern matching on our arguments...)

\begin{lstlisting}
rec main : {g:ctx}{M:[g.tm A]} RedSub [. #S] -> Reduce [.A] [. M #S] =
...
``higher-order'' aspect of these encodings is a red herring.

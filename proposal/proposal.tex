...
\item technique for induction principle: induct over ``all of LF''
  uniformly, permitting mutual definitions, etc.
...
\item backup/option: implementation (prototype?). Some kind of
  (``structural''?) ``initial algebra semantics'' for hypothetical judgments?

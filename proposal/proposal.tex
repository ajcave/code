...
verify that a recursive function corresponds to an inductive proof. However, the techniques
...
programming to \emph{proving}. Another question is whether we can move
...
the translation to a HOAS-based formalization.

The grammar for the calculus includes on lambda abstractions, variables, application, and a single

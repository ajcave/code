...
Main example: NbE. Difficult/impossible for other HOAS based systems.
...
For example, a typical context relation might take relate a context
...
System F). Below we write this relation in surface syntax and the
corresponding form in the core theory. This is a typical example of
functional relation: in proofs, we will often be obligated to prove
that it is total and deterministic.

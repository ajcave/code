...
All this effort for one of the simplest imaginable programming
languages. As the number of constructs in our language grows, or as we
begin to consider several languages, these lemmas quickly become a major
burden. 

Illustrate the point that the main bottleneck for
mechanization are the equations which arise.

Higher-order abstract syntax solves some of these issues, but it
...
was represented directly as a function. 

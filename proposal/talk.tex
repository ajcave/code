...
\begin{frame}[fragile]{Example: Simply-typed lambda calculus definition}
% Focus here on tal
...
\begin{frame}{Proposed work: Dependent Type Theory for Contextual Reasoning}
\begin{enumerate}
\item Theory
\begin{itemize}
\item Move from indexed types (Beluga) to dependent types

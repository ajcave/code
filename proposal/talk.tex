...
\pause \item Lots of work on languages for machine-checkable proofs (Automath, Mizar, Coq, ...)
\pause \item Is writing machine-checkable proofs viable?
...
\mbox{Terms} & M,N & \bnfas & {\const c} \bnfalt {\color{purple}x} \bnfalt {\color{purple} \lam x M} \bnfalt M\;N \\
...
% type theory
\item Unifies programming and proving!
...
\item Still not enough to directly express advanced results...
